...
const PDF_FILES: PdfEntry[] = [
  {
    name: "Sample Delivery Slip",
    filename: "sample.pdf",
  },
];
...
function PdfSignPage() {
  ...
  const selectedPdfUrl = useMemo(() => {
    ...
    return `/pdfs/${selectedPdf.filename}`;
  }, [selectedPdf]);
  ...
  useEffect(() => {
    ...
    context.strokeStyle = "#111827"; // gray-900
    ...
    <div className="px-4 pb-8">
      <div className="max-w-6xl mx-auto">
        <header className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900">PDF Signing</h1>
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Drop additional files into <span className="font-semibold">frontend/public/pdfs</span> to see them listed here.
              </p>
            </div>
        ...
        <section className="bg-white border border-gray-200 rounded-lg shadow-sm p-4">
          ...
          <div className="mt-4 relative bg-gray-50 border border-dashed border-gray-300 rounded-lg min-h-[400px] flex items-center justify-center" ref={viewerRef}>
            {selectedPdfUrl ? (
              <div className="w-full flex justify-center py-4">
                <div className={`relative ${isDrawing ? "ring-2 ring-[#800000] ring-offset-2" : ""}`} style={{ width: renderSize?.width ?? "100%" }}>
                  <Document
                  ...
                  {renderSize && (
                    <canvas
                      ref={canvasRef}
                      className={`absolute inset-0 ${selectedPdf ? "cursor-crosshair" : "cursor-not-allowed"}`}
